...
- **切换数据库**：双击左侧数据库节点或右键选择「设为当前数据库」
- **表信息查看**：单击表节点或右键菜单查看建表语句
- **性能优化**：
  - 异步加载数据库列表，避免 UI 卡顿
  - 懒加载表列表，展开数据库时才加载表，提升响应速度

## 更新日志

### 2026-03-11
- **新增**：双击或右键数据库节点切换当前活跃数据库
- **优化**：数据库列表和表列表改为异步加载，解决 UI 卡顿问题
- **优化**：实现懒加载机制，初始只加载数据库节点，展开时才加载表
- **新增**：单击表节点或右键菜单查看建表语句，右侧面板显示
